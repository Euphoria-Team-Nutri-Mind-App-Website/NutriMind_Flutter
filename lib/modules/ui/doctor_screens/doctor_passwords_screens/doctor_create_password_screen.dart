...
class DoctorCreatePasswordScreen extends StatefulWidget {
  const DoctorCreatePasswordScreen({Key? key, required this.email}) : super(key: key);
  final String email;

  @override
  State<DoctorCreatePasswordScreen> createState() => _DoctorCreatePasswordScreen();
}

class _DoctorCreatePasswordScreen extends State<DoctorCreatePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: MyAppBar(backPage: 'DoctorVerificationScreen'),
        body: SafeArea(
          child: Container(
                                    ...
                                    onPressed: () async {
                                      if (formKey.currentState!.validate()) {
                                        ...
                                        var request = http.MultipartRequest('POST',
                                            Uri.parse(
                                                '$BASEURl/doctor/api/doctor/reset-password?email=${widget.email}'));
