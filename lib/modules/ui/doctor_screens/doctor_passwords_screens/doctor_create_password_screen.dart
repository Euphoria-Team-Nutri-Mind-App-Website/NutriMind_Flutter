...
class DoctorCreatePasswordScreen extends StatefulWidget {
  const DoctorCreatePasswordScreen({Key? key}) : super(key: key);

  @override
  State<DoctorCreatePasswordScreen> createState() =>
      _DoctorCreatePasswordScreenState();
}

class _DoctorCreatePasswordScreenState
    extends State<DoctorCreatePasswordScreen> {
